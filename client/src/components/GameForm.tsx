...
export default function GameForm() {
    ...
    return <form noValidate={true}  onSubmit={handleSubmit} className="grid place-items-center shadow-md bg-neutral-50 rounded px-8 pt-6 pb-8 mb-4 gap-2" id="gameForm">
                <p>Game ID</p>
